...
WebUI.setText(findTestObject('Object Repository/OrangeHRM/Login/Name Parameter',[('name_parameter') : 'username' ]), username)

WebUI.setText(findTestObject('Object Repository/OrangeHRM/Login/Name Parameter',[('name_parameter') : 'password' ]), password)
